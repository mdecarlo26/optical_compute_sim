...
Previous studies have demonstrated optical implementations of linear operations such as matrix multiplication \cite{ref:shen2017deep, ref:harris2018linear} and partial photonic neural networks. However, integrating all stages of a CNN—especially non-linear activations and bias functions—into a fully optical environment remains largely unexplored. Our project extends the literature by proposing a holistic, simulation-based ONN architecture that addresses these gaps using programmable MZIs.
...
\begin{itemize}
    ...
    \end{itemize}
    \item Finalize the simulation toolchain (MATLAB/Python for neural nets, photonic CAD tools for optical models).
\end{itemize}
...
\begin{tabular}[c]{@{}l@{}}
- \$15,000 \\
(Licenses for photonic simulation software, \\
